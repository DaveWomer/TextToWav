...
public class ByteArrayAudioPlayer implements AudioPlayer {
    ...
    private String baseName ="base.wav";
     ...
     *
     */
    public ByteArrayAudioPlayer(AudioFileFormat.Type type) {
    ...
    public ByteArrayAudioPlayer(String basename, AudioFileFormat.Type type) {
	...
	try {
	    ...
	    this.setByteArray(os.toByteArray());
